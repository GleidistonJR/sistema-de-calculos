...
tipoMaterialInput.addEventListener("change", () => {
    verificarMaterial()
});
...
function calcular() {
    ...
    if (calcVenda != 0 && calcValorPers == 0) {
        ...
        textoOrcamento = `
Acrílico ${corInput.value} ${espessuraInput.value}mm, medindo ${valorX * 100}x${valorY * 100} centímetros
(Apenas corte)

R$ ${calcVenda.toFixed(2)} - Unidade

Tempo médio para ser produzido de 1 dia útil.
